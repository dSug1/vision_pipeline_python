...
### ⭐⭐⭐ YOU ARE HERE (2026-08-24, LATEST) — **NEXT BUILD IS T6d: THE ANISOTROPIC FIT, LIVE, WITH SLIDERS.**
...
⭐⭐ **READ `HANDOFF_T6_ORIENTATION_FROM_2D.md` — its NEXT BUILD block at the top is a
complete, immediately actionable brief.** Then §2.0.16 for the fit, §2.0.9/§2.0.12
