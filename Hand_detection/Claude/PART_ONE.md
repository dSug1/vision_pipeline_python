...
### ⭐ YOU ARE HERE (2026-08-04) — 1.5 is BUILT; next is 1.6
...
|---|---|---|
| **1** | **1.6** M4 consistency gate (+S5) | 1.5's validity bit now exists and has nothing consuming it; 1.6 is what turns it into a measured pipeline improvement under A10 |
| **2** | **1.7** impose a skeleton via constrained IK (+S7) | **replaces dead 1.4**; supplies the pose-consistent skeleton and M9's scale reference. ⚠ **NOT with real MANO** — see N13 |
| **3** | **T1 / T2 retest** | the first honest re-test after attacking landmark quality at source |
| **4** | **R** reassess (owner decision point) | then Phase 3 (3.1 M7, now unblocked) or Phase 4 features |
