...
### ✅ YOU ARE HERE (2026-08-22, END OF SESSION) — **THREE FIXES SHIPPED AND OWNER-ACCEPTED LIVE.**
...
| **U8** — rule 3 may not act on a PROVISIONAL chirality | `ChiralityResolver.confirmed`, gating `can_snap` in both tools | `CHIRALITY_CONFIRM_FRAMES = 6` |
