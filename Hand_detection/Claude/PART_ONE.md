...
### ✅ YOU ARE HERE (2026-08-23, LATEST) — **4.2 IS BUILT AND OWNER-CONFIRMED LIVE.**

> Owner, watching the debug tool: ***"yes. this is working properly"***
...
| ✅ **live** | debug tool, 2026-08-23 — owner: *"yes. this is working properly"*. Take: `2026-08-23_193716_4_2_zaxis_debug_first_look`, the **first session ever written at `recorder_schema: 3`** |
| ⚠ **still open** | **PRODUCTION has not been watched.** One camera means the two tools can never run at once, so this is a separate back-to-back session — and §13.6.1's inversion was production-only. `parity_replay` says the logic agrees; that is evidence, not a substitute for looking |
