...
| order | item | why |
|---|---|---|
| **R** | **reassess — ARRIVED EARLY, owner decision** | Phase 1 is exhausted; the queue's own gate applies now rather than after 1.7 |
| then | **4.1 M9 metric depth** → **4.2 Z-axis translation** | the surviving deliverable unblocks a real feature, on the one thing this sensor measures well |
| or | **4.3 M10.7 grace period** | also closes N8 (cube-stealing). ⚠ changes `GAME_RULES.md` rule 2 — owner sign-off first |
